...
// Insert type
export type InsertLink = TablesInsert<"links">;
export type InsertProfile = TablesInsert<"profiles">;
export type InsertLinkClick = TablesInsert<"link_clicks">;

// Update type
export type UpdateLink = TablesUpdate<"links">;
export type UpdateProfile = TablesUpdate<"profiles">;
export type UpdateLinkClick = TablesUpdate<"link_clicks">;
